...
class Vc(commands.Cog):
  ...
  async def ding(self, ctx, loop=None): 
    await self.vcplay(ctx,"sounds/DING DING DING DING DING DING DING DI DI DING.mp3",loop) 
  ...
  async def jonathan(self, ctx, loop=None):  
    await self.vcplay(ctx,"sounds/Jonathan's theme but its only the BEST part.mp3",loop)      

  @commands.command()
  async def joseph(self, ctx, loop=None):  
    await self.vcplay(ctx,"sounds/Joseph's theme but only the good part (1).mp3",loop)        

  @commands.command()
  async def jotaro(self, ctx, loop=None):  
    await self.vcplay(ctx,"sounds/Jotaro’s theme but it’s only the good part.mp3",loop) 

  @commands.command()
  async def josuke(self, ctx, loop=None):  
    await self.vcplay(ctx,"sounds/Josuke theme but it's only the good part.mp3",loop)   

  @commands.command()
  async def kira(self, ctx, loop=None):  
    await self.vcplay(ctx,"sounds/Killer (Yoshikage Kira's Theme) - Jojo's Bizarre Adventure Part 4_ Diamond Is Unbreakable.mp3",loop)        

  @commands.command()
  async def pillarmen(self, ctx, loop=None): 
    await self.vcplay(ctx,"sounds/Jojo's Bizarre Adventure- Awaken(Pillar Men Theme).mp3",loop)     
